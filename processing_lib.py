...
def get_ripples_episodes_indexes(ripples_lfp, fs, threshold=4, accept_win=0.02):
    """
    :param ripples_lfp: lfp signal filtered in ripple freqs
    :param fs: discretisation frec
    :param threshold: threshold for ripple detection
    :param accept_win: min ripple duration, sec
    :return:  list of starts and ends of ripples in (fs)
    """
